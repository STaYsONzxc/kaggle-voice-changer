...
class VoiceChangerV2(VoiceChangerIF):
    ...
    def __init__(self, params: VoiceChangerParams):
        ...
        self.currentCrossFadeOverlapSize = 0  # настройка
        self.crossfadeSize = 0  # рассчитано
        ...
        if torch.cuda.is_available() and self.gpu_num > 1:
            print("Let's use", torch.cuda.device_count(), "GPUs!")
            self.voiceChanger = nn.DataParallel(self.voiceChanger)
